...
switch ($t_module ["param"]) {
	...
	case "list":
		...
		$smarty->assign ( "corps", "type_perimetre/typePerimetreListe.tpl" );
		break;
	...
	*/
	case "display":
		...
		$smarty->assign ( "data", $data );
		$smarty->assign ( "corps", "type_perimetre/typePerimetreDisplay.tpl" );
		break;
	...
	*/
	case "change":
		...
		dataRead ( $dataClass, $id, "type_perimetre/typePerimetreChange.tpl" );
		break;
