...
<a href="index.php?module=echelleDisplay&id={$data.echelle_id}" style="padding-left:2em">Retour au détail de la fiche</a>
...
<input type="hidden" name="id" value="{$data.echelle_id}">
