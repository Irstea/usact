...
&nbsp;
<a href="index.php?module=juridiqueDisplay&juridique_id={$juridique.juridique_id}" >
Retour au détail de l'acte juridique {$juridique.juridique_id}</a>
...
<input type="hidden" name="juridique_id" value="{$juridique.juridique_id}">
<input type="hidden" name="module" value="juridiqueConflitWrite">
...
<input type="hidden" name="juridique_id" value="{$juridique.juridique_id}">
<input type="hidden" name="module" value="juridiqueConflitDelete">
