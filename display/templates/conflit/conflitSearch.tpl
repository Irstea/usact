...
{if $objet_niv2[lst].objet_niv2_libelle == null} hitden {/if}
>
...
{if $objet_niv1[lst].objet_niv1_libelle == null} hitden {/if}
>
...
{if $bien_support_niv2[lst].bien_support_niv2_libelle == null} hitden {/if}
>
...
{if $bien_support_niv1[lst].bien_support_niv1_libelle == null} hitden {/if}
>
