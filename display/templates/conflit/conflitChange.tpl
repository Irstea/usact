<h2>Modification d'un conflit</h2>
...
<input type="hidden" name="idpers" value="{$data.personne_saisie_conflit_id}">
<input type="hidden" name="module" value="conflitWrite">
<table class="tablesaisie">
<tr>
<td>ID<span class="red">*</span> :</td>
<td><input name="arcachon.personne_saisie_conflit.personne_saisie_conflit_id" value="{$data.personne_saisie_conflit_id}"></td>
</tr>
<tr>
<td>Nom<span class="red">*</span> :</td>
<td><input name="arcachon.personne_saisie_conflit.personne_saisie_conflit_nom" value="{$data.personne_saisie_conflit_nom}"autofocus></td>
</tr>
<tr>
<td>Prénom<span class="red">*</span> :</td>
<td><input name="arcachon.personne_saisie_conflit.personne_saisie_conflit_prenom" value="{$data.personne_saisie_conflit_prenom}"></td>
</tr>
<tr>
<td>Date de début :</td>
