...
Retour à l'expert n° {$data.expert_id}
</a>
...
<dd>
<input class="commentaire" name="institution" value="{$data.institution}" required>
</dd>
</dl>
<dl>
<dt>Statut de l'interviewé<span class="red">*</span> :</dt>
<dd>
<input class="commentaire" name="statut" value="{$data.statut}" required>
...
<dd>
<input class="commentaire" name="localisation" value="{$data.localisation}" required>
</dd>
</dl>
<dl>
<dt>Binôme<span class="red">*</span> :</dt>
<dd>
<input class="commentaire" name="binome" value="{$data.binome}" required>
